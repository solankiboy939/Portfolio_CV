                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          -Passionate about AGI, sustainability, and creating tech that solves real-world problems
                          -Gained certifications and training from GeeksforGeeks and academic projects in MLDS
